  ...
  render() {
    ...
    const body = (
      <div>
        ...
        {user.role === Role.ADMIN && (
          <p className="text-center">Demote this user?</p>
        )}
        {user.role === Role.USER && (
          <p className="text-center">Make this user an admin?</p>
        )}
    ...
    const footer = (
      <div className="m-auto">
        {user.role === Role.ADMIN && (
          <Button color="danger" onClick={() => this.onSetRole(Role.USER)}>
            Demote
          </Button>
        )}
        {user.role === Role.USER && (
          <Button color="primary" onClick={() => this.onSetRole(Role.ADMIN)}>
            Promote
          </Button>
        )}
      </div>
