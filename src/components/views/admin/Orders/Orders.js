...
class Orders extends React.Component {
  ...
  fetchOrders = (config = {}) => {
    ...
    const link = `/orders?related=menu_item|user&page=${page}&search=${search}&per_page=${perPage}&time=today`;
  ...
  render() {
    const { data, error, pageInfo, toManage, manageIsOpen } = this.state;
