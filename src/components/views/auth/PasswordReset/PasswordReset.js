...
class PasswordReset extends React.Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      .put("auth/password-reset", this.state)
      .then(({ data }) => {
        this.setState({
          ...this.state,
          success: true,
  ...
  render() {
    ...
    if (success) {
      return (
        <AuthPage
          styles={{ minHeight: "500px", height: "100vh" }}
          loading={loading}
        >
          <form className="col-12 col-md-6 offset-md-3 col-lg-4 offset-lg-4 card">
            <h5 className="text-center mb-3 mt-4">Password Reset</h5>
            <Alert color="success">
              Password successfully reset. Please proceed to login.
            </Alert>
            <Link to="/login" className="btn btn-primary mt-2 mb-4">
              Login
            </Link>
          </form>
        </AuthPage>
    ...
    return (
      ...
      >
        ...
        >
          ...
          {success && <Alert color="danger">Password successfully</Alert>}
          ...
          <input
            ...
            onChange={this.onChange}
          />
          <Button disabled={loading} className="btn btn-primary mt-2 mb-4">
            Reset
          </Button>
        </form>
      </AuthPage>
