        ...
        >
          ...
          {error && (
            <div>
              ...
              <p className="p-2">
                An error occured while verifying your email account, please try
                again.
              </p>
            </div>
          )}
          {success && (
            <div>
              <Alert color="success">Verification successful!</Alert>
              <p className="p-2">
                You have successfully verified your email address. Please
                proceed to login.
              </p>
          ...
          {!error && !success && (
            <p className="p-2">Verifying your email address...</p>
          )}
        </div>
      </AuthPage>
    );
